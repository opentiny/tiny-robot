...
const mockTemplates = {
  ...
  default: [(messages: ChatCompletionRequestMessage[]): string => {
...
export const generateMockResponse = (messages: ChatCompletionRequestMessage[]): string => {
  ...
  return typeof templates[randomIndex] === 'function' ? (templates[randomIndex] as Function)(messages) : String(templates[randomIndex]);
};