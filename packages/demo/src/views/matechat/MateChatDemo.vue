<template>
  <div class="demo-test">
    <McHeader :logoImg="'https://matechat.gitcode.com/logo.svg'" :title="'MateChat'">
    ...
    <div class="new-convo-button">
      ...
      <div v-else class="agent-knowledge">
        <d-dropdown :position="['top']" @toggle="(val: boolean) => (isAgentOpen = val)">
          ...
          <template #menu>
            <McList :data="agentList" @select="(val: ListItem) => (selectedAgent = val)"></McList>
          </template>
        </d-dropdown>
