...
.template-block {
  display: inline;
  color: var(--tr-sender-template-color);
  background: var(--tr-sender-template-bg);
  padding: var(--tr-sender-template-padding);
  margin: var(--tr-sender-template-margin);
  border-radius: var(--tr-sender-template-border-radius);
  cursor: text;
  ...
  &.is-empty {
    ...
    min-width: var(--tr-sender-template-min-width);
    line-height: 1.1em;
  }
