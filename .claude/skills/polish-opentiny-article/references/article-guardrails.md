...
|---|---|---|
| 段落、列表说明、图片说明、Markdown 链接显示文本 | Front Matter、已确认标题、代码/命令/日志/报错、API 与参数、版本号/SHA/路径/URL、图片与链接目标、图表源、引用原文、人工区域与验收项 | Head SHA 漂移、与固定来源冲突、无法区分正文与受保护区、越过授权章节、缺少支撑结论的来源、必读资料缺失 |
