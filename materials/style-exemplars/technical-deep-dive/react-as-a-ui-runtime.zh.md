...
> 标题：将 React 作为 UI 运行时
> 作者：Dan Abramov（中文译文由读者维护）
> 出处 URL：https://chojaehun.github.io/zh-hans/react-as-a-ui-runtime/
> 采集日期：2026-06-25
...
[![React homepage screenshot:](https://chojaehun.github.io/static/0429fcb4a2f2022852afc698ff8968f1/74bd4/react.png)](https://chojaehun.github.io/static/0429fcb4a2f2022852afc698ff8968f1/74bd4/react.png)

我曾经写过关于构建[用户界面](https://chojaehun.github.io/zh-hans/the-elements-of-ui-engineering/)会遇到的难题一文。但是本篇文章将以一种不同的方式来讲述 React — 因为它更像是一种[编程运行时](https://en.wikipedia.org/wiki/Runtime_system)。
...
_(注意：我省略了一些对此解释不重要的[属性](https://chojaehun.github.io/zh-hans/why-do-react-elements-have-typeof-property/))_
