const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Basic.DkZbOi_3.js","assets/chunks/index.DiRjSv6i.js","assets/chunks/framework.kTfunus-.js","assets/chunks/tiny-robot-svgs.Ct4S-7ct.js"])))=>i.map(i=>d[i]);
import{p as k,v as d,V as g,C as o,c as E,o as y,j as i,ah as F,G as a,ag as c,a as t,ai as C,k as n,w as p}from"./chunks/framework.kTfunus-.js";import{O as A,E as v}from"./chunks/index.Bs5OpVoR.js";const D=`<template>
  <h1>会话</h1>
...
`,f=JSON.parse('{"title":"对话管理 useConversation","description":"","frontmatter":{},"headers":[],"relativePath":"tools/conversation.md","filePath":"tools/conversation.md"}'),u={name:"tools/conversation.md"},_=Object.assign(u,{setup(B){const l=k(!0),h=k();return d(async()=>{h.value=(await g(async()=>{const{default:e}=await import("./chunks/Basic.DkZbOi_3.js");return{default:e}},__vite__mapDeps([0,1,2,3]))).default}),(e,s)=>{const r=o("ClientOnly");return y(),E("div",null,[s[1]||(s[1]=i("h1",{id:"对话管理-useconversation",tabindex:"-1"},[t("对话管理 useConversation "),i("a",{class:"header-anchor",href:"#对话管理-useconversation","aria-label":'Permalink to "对话管理 useConversation"'},"​")],-1)),s[2]||(s[2]=i("p",null,[i("code",null,"useConversation"),t(" 是一个对话管理工具，它可以帮助你管理对话的状态和历史记录。")],-1)),s[3]||(s[3]=i("h2",{id:"示例",tabindex:"-1"},[t("示例 "),i("a",{class:"header-anchor",href:"#示例","aria-label":'Permalink to "示例"'},"​")],-1)),F(a(n(A),null,null,512),[[C,l.value]]),a(r,null,{default:p(()=>[a(n(v),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:s[0]||(s[0]=()=>{l.value=!1}),vueCode:n(D)},{vue:p(()=>[a(n(h))]),_:1},8,["vueCode"])]),_:1}),s[4]||(s[4]=c(`<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-label="Permalink to &quot;API&quot;">​</a></h2><p><code>useConversation</code> 返回以下内容：</p><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">interface</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> UseConversationReturn</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre></div>`,10))])}}});export{f as __pageData,_ as default};
