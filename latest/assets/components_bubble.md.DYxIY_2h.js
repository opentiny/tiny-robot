const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/state-change.CZPPzGVn.js","assets/chunks/framework.BFVoXPbU.js","assets/chunks/theme.BtbsuwBD.js","assets/chunks/custom-renderer.C-_Wapvj.js","assets/chunks/tools.IvYjuey-.js","assets/chunks/reasoning.C9VRdhtv.js","assets/chunks/provider-renderer.CZO-zI7F.js","assets/chunks/list-auto-scroll.CBSz8Aiy.js","assets/chunks/list-hidden.V_y70TbI.js","assets/chunks/list-array-content.acA77feu.js","assets/chunks/list-custom-group.C9r2o0lX.js","assets/chunks/list-consecutive.C5-xjAj2.js","assets/chunks/list.BK51isdC.js","assets/chunks/schema-render.VfRH56qq.js","assets/chunks/slots.DwdoR58t.js","assets/chunks/content-resolver.B_bb8nOv.js","assets/chunks/content-render-mode.DlyV9oaY.js","assets/chunks/image.BiXI7mlC.js","assets/chunks/streaming.Dl0H_zxd.js","assets/chunks/markdown.DkUocSiX.js","assets/chunks/loading.BNMLW3Lc.js","assets/chunks/shape.gtLUw40p.js","assets/chunks/avatar-and-placement.Da1OA59a.js","assets/chunks/basic.CMmKc50z.js"])))=>i.map(i=>d[i]);
import{aD as u,bQ as b,aZ as q,aL as J,v as V,H as y,bL as r,bB as p,J as t,bk as s,bJ as i,G as h,w as l,I as o,b7 as g,aU as z}from"./chunks/framework.BFVoXPbU.js";import{L as c,N as k}from"./chunks/index.CVxpCY4Y.js";const U=`<template>
...
import { TrBubble } from '@opentiny/tiny-robot'
<\/script>
`,ge=JSON.parse('{"title":"Bubble 气泡组件","description":"","frontmatter":{"outline":[1,3]},"headers":[],"relativePath":"components/bubble.md","filePath":"components/bubble.md"}'),ce={name:"components/bubble.md"},ye=Object.assign(ce,{setup(ke){const E=g();u(async()=>{E.value=(await b(async()=>{const{default:a}=await import("./chunks/state-change.CZPPzGVn.js");return{default:a}},__vite__mapDeps([0,1,2]))).default});const v=g();u(async()=>{v.value=(await b(async()=>{const{default:a}=await import("./chunks/custom-renderer.C-_Wapvj.js");return{default:a}},__vite__mapDeps([3,2,1]))).default});const C=g();u(async()=>{C.value=(await b(async()=>{const{default:a}=await import("./chunks/tools.IvYjuey-.js");return{default:a}},__vite__mapDeps([4,1,2]))).default});const f=g();u(async()=>{f.value=(await b(async()=>{const{default:a}=await import("./chunks/reasoning.C9VRdhtv.js");return{default:a}},__vite__mapDeps([5,1,2]))).default});const m=g();u(async()=>{m.value=(await b(async()=>{const{default:a}=await import("./chunks/provider-renderer.CZO-zI7F.js");return{default:a}},__vite__mapDeps([6,2,1]))).default});const B=g();u(async()=>{B.value=(await b(async()=>{const{default:a}=await import("./chunks/list-auto-scroll.CBSz8Aiy.js");return{default:a}},__vite__mapDeps([7,1,2]))).default});const A=g();u(async()=>{A.value=(await b(async()=>{const{default:a}=await import("./chunks/list-hidden.V_y70TbI.js");return{default:a}},__vite__mapDeps([8,2,1]))).default});const F=g();u(async()=>{F.value=(await b(async()=>{const{default:a}=await import("./chunks/list-array-content.acA77feu.js");return{default:a}},__vite__mapDeps([9,2,1]))).default});const x=g();u(async()=>{x.value=(await b(async()=>{const{default:a}=await import("./chunks/list-custom-group.C9r2o0lX.js");return{default:a}},__vite__mapDeps([10,2,1]))).default});const D=g();u(async()=>{D.value=(await b(async()=>{const{default:a}=await import("./chunks/list-consecutive.C5-xjAj2.js");return{default:a}},__vite__mapDeps([11,2,1]))).default});const _=g();u(async()=>{_.value=(await b(async()=>{const{default:a}=await import("./chunks/list.BK51isdC.js");return{default:a}},__vite__mapDeps([12,2,1]))).default});const T=g();u(async()=>{T.value=(await b(async()=>{const{default:a}=await import("./chunks/schema-render.VfRH56qq.js");return{default:a}},__vite__mapDeps([13,1,2]))).default});const R=g();u(async()=>{R.value=(await b(async()=>{const{default:a}=await import("./chunks/slots.DwdoR58t.js");return{default:a}},__vite__mapDeps([14,2,1]))).default});const W=g();u(async()=>{W.value=(await b(async()=>{const{default:a}=await import("./chunks/content-resolver.B_bb8nOv.js");return{default:a}},__vite__mapDeps([15,2,1]))).default});const w=g();u(async()=>{w.value=(await b(async()=>{const{default:a}=await import("./chunks/content-render-mode.DlyV9oaY.js");return{default:a}},__vite__mapDeps([16,2,1]))).default});const I=g();u(async()=>{I.value=(await b(async()=>{const{default:a}=await import("./chunks/image.BiXI7mlC.js");return{default:a}},__vite__mapDeps([17,1,2]))).default});const S=g();u(async()=>{S.value=(await b(async()=>{const{default:a}=await import("./chunks/streaming.Dl0H_zxd.js");return{default:a}},__vite__mapDeps([18,2,1]))).default});const Z=g();u(async()=>{Z.value=(await b(async()=>{const{default:a}=await import("./chunks/markdown.DkUocSiX.js");return{default:a}},__vite__mapDeps([19,2,1]))).default});const G=g();u(async()=>{G.value=(await b(async()=>{const{default:a}=await import("./chunks/loading.BNMLW3Lc.js");return{default:a}},__vite__mapDeps([20,1,2]))).default});const M=g();u(async()=>{M.value=(await b(async()=>{const{default:a}=await import("./chunks/shape.gtLUw40p.js");return{default:a}},__vite__mapDeps([21,2,1]))).default});const L=g();u(async()=>{L.value=(await b(async()=>{const{default:a}=await import("./chunks/avatar-and-placement.Da1OA59a.js");return{default:a}},__vite__mapDeps([22,2,1]))).default});const n=z(!0),P=g();return u(async()=>{P.value=(await b(async()=>{const{default:a}=await import("./chunks/basic.CMmKc50z.js");return{default:a}},__vite__mapDeps([23,2,1]))).default}),(a,e)=>{const d=q("ClientOnly");return J(),V("div",null,[e[23]||(e[23]=y('<h1 id="bubble-气泡组件" tabindex="-1">Bubble 气泡组件 <a class="header-anchor" href="#bubble-气泡组件" aria-label="Permalink to &quot;Bubble 气泡组件&quot;">​</a></h1><div class="danger custom-block"><p class="custom-block-title">重大版本升级 v0.4</p><p>Bubble 在 v0.4 进行了重大升级。</p><p><strong>从 v0.3.x 升级？</strong> 请查看 <a href="./../migration/bubble-migration.html">Bubble 迁移指南</a>。</p><p><strong>新项目：</strong> 直接使用下方 v0.4 的 API 和示例即可。</p></div><p>Bubble 气泡组件用于展示消息气泡，支持流式文本、头像、位置、加载中、终止状态、操作按钮等功能。组件采用渲染器架构，支持灵活的内容渲染和自定义扩展。</p><p>主要解决以下问题：</p><ul><li><strong>消息展示</strong>：支持文本、图片、Markdown 等多种内容类型的渲染</li><li><strong>流式输出</strong>：支持流式文本展示，适用于 AI 对话场景</li><li><strong>消息分组</strong>：支持将连续相同角色的消息合并显示</li><li><strong>自定义渲染</strong>：通过渲染器系统支持自定义内容渲染逻辑</li><li><strong>状态管理</strong>：支持消息状态管理，用于存储 UI 相关的数据</li></ul><h2 id="代码示例" tabindex="-1">代码示例 <a class="header-anchor" href="#代码示例" aria-label="Permalink to &quot;代码示例&quot;">​</a></h2><h3 id="基本示例" tabindex="-1">基本示例 <a class="header-anchor" href="#基本示例" aria-label="Permalink to &quot;基本示例&quot;">​</a></h3><p>基本示例。使用 <code>content</code> 属性设置气泡内容，可以使用 css 变量来设置样式，比如：</p><ul><li>气泡背景 <code>--tr-bubble-box-bg</code></li><li>气泡文字大小 <code>--tr-bubble-text-font-size</code></li></ul><blockquote><p>更多 css 变量请参考 <a href="#css-变量">CSS 变量</a></p></blockquote>',10)),r(t(s(c),null,null,512),[[p,n.value]]),t(d,null,{default:i(()=>[t(s(k),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{n.value=!1}),vueCode:s(he)},h({_:2},[P.value?{name:"vue",fn:i(()=>[t(s(P))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[24]||(e[24]=l("h3",{id:"头像和位置",tabindex:"-1"},[o("头像和位置 "),l("a",{class:"header-anchor",href:"#头像和位置","aria-label":'Permalink to "头像和位置"'},"​")],-1)),e[25]||(e[25]=l("p",null,[o("通过 "),l("code",null,"avatar"),o(" 设置自定义头像，通过 "),l("code",null,"placement"),o(" 设置位置，提供了 "),l("code",null,"start"),o("、"),l("code",null,"end"),o(" 两个选项")],-1)),r(t(s(c),null,null,512),[[p,n.value]]),t(d,null,{default:i(()=>[t(s(k),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[1]||(e[1]=()=>{n.value=!1}),vueCode:s(pe)},h({_:2},[L.value?{name:"vue",fn:i(()=>[t(s(L))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[26]||(e[26]=y('<h3 id="气泡形状" tabindex="-1">气泡形状 <a class="header-anchor" href="#气泡形状" aria-label="Permalink to &quot;气泡形状&quot;">​</a></h3><p>通过 <code>shape</code> 设置气泡形状。目前提供了 <code>rounded</code>、<code>corner</code> 和 <code>none</code> 三个选项。默认为 <code>corner</code>，可以使用 css 变量来设置圆角</p><ul><li>rounded 形状气泡圆角 <code>--tr-bubble-box-shape-rounded-radius</code></li><li>corner 形状气泡圆角 <code>--tr-bubble-box-shape-corner-radius</code>。这个 CSS 变量只会设置 corner 一个角的圆角，另外3个角则使用的 <code>--tr-bubble-box-shape-rounded-radius</code> 的值</li><li>none 形状气泡圆角 <code>--tr-bubble-box-border-radius</code></li></ul>',3)),r(t(s(c),null,null,512),[[p,n.value]]),t(d,null,{default:i(()=>[t(s(k),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[2]||(e[2]=()=>{n.value=!1}),vueCode:s(re)},h({_:2},[M.value?{name:"vue",fn:i(()=>[t(s(M))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[27]||(e[27]=l("h3",{id:"加载中",tabindex:"-1"},[o("加载中 "),l("a",{class:"header-anchor",href:"#加载中","aria-label":'Permalink to "加载中"'},"​")],-1)),e[28]||(e[28]=l("p",null,[o("通过 "),l("code",null,"loading"),o(" 设置加载中状态")],-1)),r(t(s(c),null,null,512),[[p,n.value]]),t(d,null,{default:i(()=>[t(s(k),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[3]||(e[3]=()=>{n.value=!1}),vueCode:s(de)},h({_:2},[G.value?{name:"vue",fn:i(()=>[t(s(G))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[29]||(e[29]=y(`<h3 id="渲染-markdown" tabindex="-1">渲染 markdown <a class="header-anchor" href="#渲染-markdown" aria-label="Permalink to &quot;渲染 markdown&quot;">​</a></h3><p>Bubble 组件提供了 <code>markdown</code> 渲染器，可以渲染 markdown 内容。需要安装 <code>markdown-it</code> 和 <code>dompurify</code> 依赖</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># npm</span></span>
