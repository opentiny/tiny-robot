const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/basic-source.DiEu_G2u.js","assets/chunks/framework.BrPBGZf4.js","assets/chunks/theme.DE5H-yyn.js","assets/chunks/controlled-search.D9naNVTe.js"])))=>i.map(i=>d[i]);
import{aD as C,bQ as l,aZ as u,aL as g,v as m,H as c,bL as E,bB as B,J as t,bk as n,bJ as o,G as A,b7 as p,aU as D}from"./chunks/framework.BrPBGZf4.js";import{L as h,N as b}from"./chunks/index.CIWzME_L.js";const v=`<template>
  <section class="demo">
    <div class="controls">
      <span>展开模式</span>
